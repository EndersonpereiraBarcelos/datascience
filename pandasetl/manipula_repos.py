...
class ManipulaRepositorios:
    ...
    def __init__(self, username):
        ...
        self.access_token='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'
...
novo_repo = ManipulaRepositorios('EndersonpereiraBarcelos')
...
# novo_repo.add_arquivo(nome_repo, 'linguagens_amzn.csv', 'linguagens_amzn.csv')
# novo_repo.add_arquivo(nome_repo, 'linguagens_netflix.csv', 'linguagens_netflix.csv')
# novo_repo.add_arquivo(nome_repo, 'linguagens_spotify.csv', 'linguagens_spotify.csv')
novo_repo.add_arquivo(nome_repo, 'dados_repos.py', './pandasetl/dados_repos.py')